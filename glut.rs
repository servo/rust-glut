...
local_data_key!(display_tls_key, DisplayFun)
local_data_key!(keyboard_tls_key, KeyboardFun)
local_data_key!(mouse_tls_key, MouseFun)
local_data_key!(motion_tls_key, MotionFun)
local_data_key!(passive_motion_tls_key, PassiveMotionFun)
local_data_key!(timer_tls_key, TimerFun)
local_data_key!(reshape_tls_key, ReshapeFun)
local_data_key!(idle_tls_key, IdleFun)
#[cfg(target_os="linux")]
#[cfg(target_os="android")]
local_data_key!(mouse_wheel_tls_key, MouseWheelFun)
